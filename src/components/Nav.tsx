      ...
      <header className={`${styles.header} ${scrolled ? styles.scrolled : ''}`}>
        ...
        <div className={styles.right}>
          <ul className={styles.social}>
            <li>
              <a href="https://www.linkedin.com/in/oumaima-ogeb/" target="_blank" rel="noreferrer" aria-label="LinkedIn">
            ...
            <li>
              <a href="https://www.instagram.com/oumaima_ogeb/" target="_blank" rel="noreferrer" aria-label="Instagram">
            ...
            <li>
              <a href="mailto:amenyelokb@gmail.com" aria-label="Email">
            ...
            <li>
              <a href="https://wa.me/21658000000" target="_blank" rel="noreferrer" aria-label="WhatsApp">
